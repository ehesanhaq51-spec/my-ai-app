...
# নোট: কোডের সিকিউরিটি বা ভবিষ্যতের সুবিধার জন্য চাইলে এটি Streamlit Secrets-এও রাখতে পারেন
GROQ_API_KEY = "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"
client = Groq(api_key=GROQ_API_KEY)

st.set_page_config(
    page_title="Ehesan's Smart AI", page_icon="🚀", layout="wide"
)
...
# ৪. অডিও ও ভিডিও গাইড মোড
  ...
  st.markdown("""
    ...
    * **[Pika Art](https://pika.art/)** - এনিমেশন তৈরির জন্য দারুণ।
    """)
  st.info(
      "আপনার স্ক্রিপ্টটি ইংরেজিতে অনুবাদ করতে চাইলে বাম পাশের 'চ্যাট বন্ধু' ব্যবহার"
      " করুন।"
  )
